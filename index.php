...
<body class="home">
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/homeimg.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Order using Dabbe Da Adda</h1>
                    <h5 class="font-white space-xs">Find tasty, delicious, home-made food!</h5>
                    <div class="banner-form">
                        <form class="form-inline" method="get" name="search" action="display-cities.php">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">Search Area....</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount"  name="searchdata" id="searchdata" placeholder="Search Area...."> </div>
                            </div>
							
                            <button type="submit" name="search" class="btn theme-btn btn-lg">Search</button>
                        </form>
                    </div>
                    <div class="steps">
        ...
        <div class="location-match text-xs-center">
            <div class="container"> <span>Popular Tiffins Here: <span class="primary-color">All over Pune</span> </span>
            </div>
        </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">The easiest way to get you Home-Made food</p>
                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose a tasty tiffin</h3>
                                    <p>We've got you covered with tiffins from various suppliers.</p>
                                </div>
                            </div>
                        </div>
