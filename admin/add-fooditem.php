...
else
{
    ...
    $query=mysqli_query($con, "insert into tblfood(CategoryName,ItemName,ItemPrice,ItemDes,Image,Admin) value('$fcat','$itemname','$price','$description','$itempic','$faname')");
    if ($query) {
    $msg="Food Item has been added.";
  }
  else
    {
      $msg="Something Went Wrong. Please try againok";
    }
...
<body>
    ...
    echo $msg;
      ...
      $query=mysqli_query($con,"select * from  tblcategory where Admin='$currentadmin' ");
              ...
              <option value="<?php echo $row['CategoryName'];?>"><?php echo $row['CategoryName'];?></option>
                  <?php } ?>  
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">List All Items:</label>
                                                <div class="col-sm-10">
												<textarea class="form-control" name="itemname" row="8" cols="12" required="true" >
													</textarea>
												</div>
                                            </div>
                                            
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Description (North Indian/South Indian/Chinese):</label>
                                                <div class="col-sm-10">
