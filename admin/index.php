...
if(isset($_POST['login']))
  {
	...
	$query1=mysqli_query($con,"select UserName from tbladmin where  UserName='$adminuser' && Password='$password'");
    $ret=mysqli_fetch_array($query);
	$ret1=mysqli_fetch_array($query1);
    if($ret>0){
      $_SESSION['fosaid']=$ret['ID'];
	  $_SESSION['fosaname']=$ret1['UserName'];
    ...
    echo $msg;
                    ...
                    <form class="m-t" role="form" action="" method="post" name="login">
						...
						<div class="row">
                                    ...
                                    <div class="col-sm-4">
                          <a href="register.php" class="btn btn-primary block full-width m-b">Register</a>
