...
if(isset($_POST['submit']))
  {
    ...
    $email=$_POST['email'];
     ...
     $query=mysqli_query($con, "update tbladmin set Name11 ='$adminname', MobileNumber='$mobno', Email='$email' where ID='$adminid'");
    if ($query) {
                            ...
                            <form id="submit" action="#" class="wizard-big" method="post" name="submit">
                                    <fieldset>
                                          <div class="form-group row"><label class="col-sm-2 col-form-label">Admin Name:</label>
                                                <div class="col-sm-10"><input name='adminname' id="adminname" class="form-control white_bg" value="<?php  echo $row['Name11'];?>">
