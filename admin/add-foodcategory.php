...
$ret=mysqli_query($con, "select CategoryName from tblcategory where CategoryName='$category' and Admin='$currentadmin'");
    $result=mysqli_fetch_array($ret);
    if($result>0){
$msg="This Category already exists!";
    }
	else{
    $query=mysqli_query($con, "insert into tblcategory(CategoryName,Admin) value('$category','$currentadmin')");
