                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-5 col-md-4 col-lg-3">
                            <div class="sidebar clearfix m-b-20">
                               ...
                               <?php
$searchfood1=$_POST['searchfood'];      
      $query=mysqli_query($con,"select * from  tblcategory where Admin='$searchfood1'");
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <label class="custom-control custom-checkbox">
                                                    <span class="custom-control-description"><a href="#?editid=<?php echo $row['CategoryName'];?>"><?php echo $row['CategoryName'];?></a></span> </label>
                                            </li>
...
$searchfood=$_POST['searchfood'];
        $sql = "SELECT * FROM tblfood where Admin like '%$searchfood%' ";
